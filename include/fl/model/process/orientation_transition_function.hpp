...
class OrientationStateTransitionFunction:
       public StateTransitionFunction<OSTFTypes::State,
                                      OSTFTypes::Noise,
                                      OSTFTypes::Input>
{
public:
    ...
    typedef LinearStateTransitionModel<Delta, Input> DeltaModel;
...
public:
    ...
    {
        return DimensionOf<State>::Value;
    }

    virtual int noise_dimension() const
    {
        return DimensionOf<Noise>::Value;
    }

    virtual int input_dimension() const
    {
        return DimensionOf<Input>::Value;
    }
