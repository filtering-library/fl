...
public:
    ...
    -> decltype(f(VariateA(), VariateB()))
    {
        ...
        enum : signed int { Points = Size<VariateA, VariateB>::Value };
    ...
    void propergate_gaussian(
            Integrand&& f,
            const Gaussian<Variate>& distr,
            PointSet<decltype(f(Variate())), Size<Variate>::Value>& Z
        ) const
    {
    ...
    void propergate_gaussian(
            ...
            PointSet<
                decltype(f(VarA(), VarB())), Size<VarA, VarB>::Value>& Z
        ) const
    {
    ...
    void propergate_gaussian(
            ...
            PointSet<VarA, Size<VarA, VarB>::Value>& X,
            PointSet<VarB, Size<VarA, VarB>::Value>& Y,
            PointSet<decltype(f(VarA(), VarB())), Size<VarA, VarB>::Value>& Z
        ) const
    {
    ...
    {
        enum : signed int { NumberOfPoints = Size<VarA, VarB>::Value };
