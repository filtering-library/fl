...
template </* your filter template arguments */> class YOUR_FILTER_NAME;
 ...
 * 
 */
template </* your filter template arguments */>
struct Traits<
           YOUR_FILTER_NAME</* your filter template arguments */>>
{   
    typedef YOUR_FILTER_NAME</* your filter template arguments */> Filter;
     ...
     * 
     * given a ProcessModel typedef in here or provided via template arguments
     */
     ...
     * 
     * given a ObservationModel typedef in here or provided via template 
     * arguments
     */
...
{
public:    
    typedef YOUR_FILTER_NAME</* your filter template arguments */> This;
